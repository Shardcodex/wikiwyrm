...
let bootstrap = () => {
  // ---- Load brand CSS after the hashed theme CSS ----
  const BRAND_SHEETS = [
    'client/scss/wikiwyrm.theme-tokens.css',
    'client/scss/wikiwyrm.theme-overrides.css'
  ]
  BRAND_SHEETS.forEach(href => {
  ...
  window.WIKI = new Vue({
    ...
    vuetify: new Vuetify({
      ...
      theme: {
        ...
        themes: {
          light: { primary: '#24362b', accent: '#b08d57', pink: '#E85D75' },
          dark: { primary: '#2f4638', accent: '#c09a62', pink: '#E85D75' }
        }
      }
    }),
    mounted () {
